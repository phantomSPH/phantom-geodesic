...
t1,E1,L1 = np.loadtxt('ev.dat-precDP-spo1k-tol1e-15',unpack=True)
t2,E2,L2 = np.loadtxt('ev.dat-precDP-spo10k-tol1e-15',unpack=True)
t3,E3,L3 = np.loadtxt('ev.dat-precDP-spo100k-tol1e-15',unpack=True)

t4,E4,L4 = np.loadtxt('ev.dat-precQP-spo1k-tol1e-30',unpack=True)
t5,E5,L5 = np.loadtxt('ev.dat-precQP-spo10k-tol1e-30',unpack=True)
t6,E6,L6 = np.loadtxt('ev.dat-precQP-spo100k-tol1e-30',unpack=True)
...
plt.plot(T[0,:],L[0,:],color=cblue,ls='solid')
plt.plot(T[1,:],L[1,:],color=cblue,ls='dashed')
plt.plot(T[2,:],L[2,:],color=cblue,ls='dotted')

plt.plot(T[3,:],L[3,:],color=cgreen,ls='solid')
plt.plot(T[4,:],L[4,:],color=cgreen,ls='dashed')
plt.plot(T[5,:],L[5,:],color=cgreen,ls='dotted')
